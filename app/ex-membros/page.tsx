    ...
    return (
        <main>
            ...
            <Box flex={1} alignItems="center">
                <Heading size='5xl' mt={80}>EX-MEMBROS</Heading>
                <Heading size='3xl'>Ex-tutores</Heading>
            </Box>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 50, alignItems: 'center', justifyContent: 'center', margin: '80px auto', padding: '0px 50px' }} >
